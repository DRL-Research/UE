from utils.path_planning.spline_utils_v0 import PathSpline
import numpy as np
import airsim
import time
import pickle
...
def following_loop(client, spline_obj=None):
    ...
    if spline_obj is None:
        ...
        spatial_utils_v0.set_airsim_pose(client, [0.0, 0.0], [90.0, 0, 0])

    # Define Stanley-method parameters:
    follow_handler = path_control_v0.StanleyFollower(spline_obj)
    ...
    while last_iteration - start_time < 300:
        ...
        if delta_time > sample_time:
            ...
            curr_pos, curr_rot = spatial_utils_v0.extract_pose_from_airsim(vehicle_pose)
